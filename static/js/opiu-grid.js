...
function opiuColumns() {
    ...
    const columns = [
        ...
        {title: 'Реклама WB по фин. отчету, руб', field: 'wb_promotion_deduction', width: 210, headerTooltip: 'Удержание WB-продвижение из финансового отчета WB. Используется в сверке прибыли с отчетом WB.', ...moneyColumn},
        ...
        {title: 'К перечислению по фин. строкам WB, руб', field: 'finance_net_for_pay', width: 230, headerTooltip: 'Сумма forPay по финансовым строкам WB, попавшим в период отчета.', ...moneyColumn},
        {title: 'Банковский перевод WB, руб', field: 'bank_payment_sum', width: 190, headerTooltip: 'bankPaymentSum из сводки финансового отчета WB.', ...moneyColumn},
        {title: 'Разница до банковского перевода WB, руб', field: 'bank_payment_difference', width: 250, headerTooltip: 'Разница между фин. строками отчета и банковским переводом WB. Должна быть расшифрована корректировками, сторно и прочими движениями.', ...moneyColumn},
        {title: 'К перечислению на р/с', field: 'net_for_pay', width: 170, ...moneyColumn},
        {title: 'Валовая прибыль до рекламы WB, руб', field: 'gross_profit', width: 210, ...moneyColumn},
