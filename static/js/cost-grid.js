    ...
    return [
        ...
        // === 📌 Основное ===
        {
            ...
            columns: [
                ...
                { title: 'Класс товара', field: 'product_class', width: 60, editor: 'input', headerSort: true, tooltip: true, cssClass: 'truncate-cell' },
                { title: 'Бренд', field: 'brand', width: 70, editor: 'input', headerSort: true, tooltip: true, cssClass: 'truncate-cell' },
                {
                ...
                { title: 'Категория', field: 'subject_name', width: 100, headerSort: true, tooltip: true, cssClass: 'truncate-cell' },
                { title: 'Арт продавца', field: 'vendor_code', width: 80, headerSort: true, tooltip: function(cell) {
                    var d = cell.getRow().getData();
                    var vc = d.vendor_code || '';
                    var sz = d.size_name && d.size_name !== '0' ? d.size_name : '';
                    return vc + (sz ? ' (' + sz + ')' : '');
                }, cssClass: 'truncate-cell' },
                { title: 'Баркод', field: '_barcodes', width: 80, headerSort: false, tooltip: true, cssClass: 'truncate-cell' },
                { title: 'Размер', field: '_sizeList', width: 60, headerSort: true },
                { title: 'Арт WB', field: 'nm_id', width: 80, headerSort: true, formatter: function(cell) { return '<b>' + cell.getValue() + '</b>'; } },
                { title: 'Товар', field: 'product_name', width: 120, headerSort: true, tooltip: true, cssClass: 'truncate-cell' },
            ]
        },
        ...
        // === 🚚 Логистика ===
        {
            ...
            columns: [
                {
                    title: 'Отгрузка', field: 'fulfillment_model', width: 65, headerSort: true,
                    editor: 'list',
        ...
        // === 💰 Себестоимость ===
        {
            title: '💰 Себестоимость',
            columns: [
                { title: 'Себестоимость ₽', field: 'cost_price', width: 100, editor: 'number', headerSort: true,
                    editorParams: { step: 0.01 }, formatter: function(cell) { const v = parseFloat(cell.getValue()); return v ? '<b>' + v.toLocaleString('ru-RU') + '</b>' : '—'; } },
                { title: 'Доп расходы ₽', field: 'extra_costs', width: 90, editor: 'number', headerSort: true },
                { title: 'Итого ₽', field: '_total_cost', width: 100, headerSort: true,
                ...
                {
                    title: 'Налог %', field: '_tax_rate_override', width: 55, headerSort: true,
                    cssClass: 'tax-cell',
                    editor: 'number',
                ...
                {
                    title: 'НДС от дохода', field: 'vat_rate', width: 55, headerSort: false,
                    editor: 'list',
        ...
        // === 📐 Габариты ПЛАН ===
        {
            title: '📐 Габариты ПЛАН',
            columns: [
                { title: 'Длина', field: 'plan_length', width: 50, editor: 'number', editorParams: {step:0.1,min:0} },
                { title: 'Ширина', field: 'plan_width', width: 50, editor: 'number', editorParams: {step:0.1,min:0} },
                { title: 'Высота', field: 'plan_height', width: 50, editor: 'number', editorParams: {step:0.1,min:0} },
                { title: 'Объём, л', field: 'plan_volume', width: 55, headerSort: true,
                    formatter: function(cell) { const v = cell.getValue(); return v ? parseFloat(v) : '—'; }
                },
                { title: 'Вес, гр', field: 'plan_weight', width: 55, editor: 'number', editorParams: {step:1,min:0} },
            ]
        },
        ...
        // === 📐 Габариты ФАКТ ===
        {
            title: '📐 Габариты ФАКТ',
            columns: [
                { title: 'Д×Ш×В', field: '_fact_dims', width: 70, tooltip: true, headerSort: false, formatter: 'plaintext' },
                { title: 'Объём, л', field: '_fact_volume', width: 55, headerSort: false },
                { title: 'Вес', field: '_fact_weight', width: 50, headerSort: false },
            ]
        },
        ...
        // === 📊 Сезонность (неделимый блок) ===
        {
            ...
            columns: [
                { title: 'янв', field: 'season_jan', width: 40, editor: 'number', cssClass: 'season-cell' },
                { title: 'фев', field: 'season_feb', width: 40, editor: 'number', cssClass: 'season-cell' },
                { title: 'мар', field: 'season_mar', width: 40, editor: 'number', cssClass: 'season-cell' },
                { title: 'апр', field: 'season_apr', width: 40, editor: 'number', cssClass: 'season-cell' },
                { title: 'май', field: 'season_may', width: 40, editor: 'number', cssClass: 'season-cell' },
                { title: 'июн', field: 'season_jun', width: 40, editor: 'number', cssClass: 'season-cell' },
                { title: 'июл', field: 'season_jul', width: 40, editor: 'number', cssClass: 'season-cell' },
                { title: 'авг', field: 'season_aug', width: 40, editor: 'number', cssClass: 'season-cell' },
                { title: 'сен', field: 'season_sep', width: 40, editor: 'number', cssClass: 'season-cell' },
                { title: 'окт', field: 'season_oct', width: 40, editor: 'number', cssClass: 'season-cell' },
                { title: 'ноя', field: 'season_nov', width: 40, editor: 'number', cssClass: 'season-cell' },
                { title: 'дек', field: 'season_dec', width: 40, editor: 'number', cssClass: 'season-cell' },
            ]
        },
        ...
        // === 🔍 ТОП запросы ===
        {
            title: '🔍 ТОП запросы',
            columns: [
                { title: '1', field: 'top_query_1', width: 70, editor: 'input', tooltip: true, cssClass: 'topquery-cell truncate-cell' },
                { title: '2', field: 'top_query_2', width: 70, editor: 'input', tooltip: true, cssClass: 'topquery-cell truncate-cell' },
                { title: '3', field: 'top_query_3', width: 70, editor: 'input', tooltip: true, cssClass: 'topquery-cell truncate-cell' },
            ]
        },
        ...
        // === 🎯 Расчёты ===
        {
            title: '🎯 Расчёты',
            columns: [
                { title: '% выкупа по кат.', field: 'buyout_niche_pct', width: 65, editor: 'number', headerSort: true },
                { title: 'Корр. комиссии %', field: 'mp_correction_pct', width: 70, editor: 'number', headerSort: true },
                { title: 'Рекл. расходы %', field: 'ad_plan_rub', width: 65, editor: 'number', editorParams: {step:0.1} },
                { title: 'Скорость достав., дн', field: 'supply_days', width: 60, editor: 'number', editorParams: {min:0} },
                { title: 'Мин партия', field: 'min_batch_fbo', width: 60, editor: 'number', editorParams: {min:1} },
                { title: 'РРЦ', field: 'rrc_price', width: 60, editor: 'number', headerSort: true },
                { title: 'Мин. цена', field: 'min_price', width: 65, editor: 'number', headerSort: true },
                { title: 'Дата правок', field: 'change_date', width: 80, tooltip: true, cssClass: 'truncate-cell', editor: 'input' },
                { title: 'Дата начала', field: 'valid_from', width: 80, tooltip: true, cssClass: 'truncate-cell', editor: 'input' },
            ]
        },
    ];
}
