...
function getCostColumns() {
    return [
        ...
        // === 📐 Габариты ПЛАН ===
        {
            title: '📐 Габариты ПЛАН',
            columns: [
                { title: 'Длина', field: 'plan_length', width: 65, editor: 'number', editorParams: {step:0.1,min:0} },
                { title: 'Ширина', field: 'plan_width', width: 65, editor: 'number', editorParams: {step:0.1,min:0} },
                { title: 'Высота', field: 'plan_height', width: 65, editor: 'number', editorParams: {step:0.1,min:0} },
                { title: 'Объём, л', field: 'plan_volume', width: 70, headerSort: true,
                    formatter: function(cell) { const v = cell.getValue(); return v ? parseFloat(v) : '—'; }
                },
                { title: 'Вес, гр', field: 'plan_weight', width: 70, editor: 'number', editorParams: {step:1,min:0} },
            ]
        },
        ...
        // === 📐 Габариты ФАКТ ===
        {
            title: '📐 Габариты ФАКТ',
            columns: [
                { title: 'Д×Ш×В', field: '_fact_dims', width: 100, headerSort: false, formatter: 'plaintext' },
                { title: 'Объём, л', field: '_fact_volume', width: 70, headerSort: false },
                { title: 'Вес', field: '_fact_weight', width: 70, headerSort: false },
            ]
        },
        ...
        // === 📊 Сезонность (неделимый блок) ===
        {
            ...
            columns: [
                { title: 'янв', field: 'season_jan', width: 50, editor: 'number', cssClass: 'season-cell' },
                { title: 'фев', field: 'season_feb', width: 50, editor: 'number', cssClass: 'season-cell' },
                { title: 'мар', field: 'season_mar', width: 50, editor: 'number', cssClass: 'season-cell' },
                { title: 'апр', field: 'season_apr', width: 50, editor: 'number', cssClass: 'season-cell' },
                { title: 'май', field: 'season_may', width: 50, editor: 'number', cssClass: 'season-cell' },
                { title: 'июн', field: 'season_jun', width: 50, editor: 'number', cssClass: 'season-cell' },
                { title: 'июл', field: 'season_jul', width: 50, editor: 'number', cssClass: 'season-cell' },
                { title: 'авг', field: 'season_aug', width: 50, editor: 'number', cssClass: 'season-cell' },
                { title: 'сен', field: 'season_sep', width: 50, editor: 'number', cssClass: 'season-cell' },
                { title: 'окт', field: 'season_oct', width: 50, editor: 'number', cssClass: 'season-cell' },
                { title: 'ноя', field: 'season_nov', width: 50, editor: 'number', cssClass: 'season-cell' },
                { title: 'дек', field: 'season_dec', width: 50, editor: 'number', cssClass: 'season-cell' },
            ]
        },
        ...
        // === 🔍 ТОП запросы ===
        {
            title: '🔍 ТОП запросы',
            columns: [
                { title: '1', field: 'top_query_1', width: 100, editor: 'input', cssClass: 'topquery-cell' },
                { title: '2', field: 'top_query_2', width: 100, editor: 'input', cssClass: 'topquery-cell' },
                { title: '3', field: 'top_query_3', width: 100, editor: 'input', cssClass: 'topquery-cell' },
            ]
        },
        ...
        // === 🎯 Расчёты ===
        {
            title: '🎯 Расчёты',
            columns: [
                { title: '% выкупа по кат.', field: 'buyout_niche_pct', width: 80, editor: 'number', headerSort: true },
                { title: 'Корр. комиссии %', field: 'mp_correction_pct', width: 85, editor: 'number', headerSort: true },
                { title: 'Рекл. расходы %', field: 'ad_plan_rub', width: 85, editor: 'number', editorParams: {step:0.1} },
                { title: 'Скорость достав., дн', field: 'supply_days', width: 90, editor: 'number', editorParams: {min:0} },
                { title: 'Мин партия', field: 'min_batch_fbo', width: 75, editor: 'number', editorParams: {min:1} },
                { title: 'РРЦ', field: 'rrc_price', width: 80, editor: 'number', headerSort: true },
                { title: 'Мин. цена', field: 'min_price', width: 85, editor: 'number', headerSort: true },
                { title: 'Дата правок', field: 'change_date', width: 105, editor: 'input' },
                { title: 'Дата начала', field: 'valid_from', width: 105, editor: 'input' },
            ]
        },
    ];
}
